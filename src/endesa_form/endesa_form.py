...
class EndesaFormFiller:
    ...
    Example::
        ...
        filler = EndesaFormFiller(
            input_path="template.pdf",
            output_path="filled.pdf",
            fields={
                "num_service": {"value": "2024-001"},
                "start_time":  {"value": "09:00"},
                "data":        {"value": "23/02/2025",
                                "styles": {"font_size": 10}},
                "dni":         {"value": "12345678A"},
            },
        )
    ...
    def generate(self) -> None:
        ...
        print(f"✅  Filled PDF saved to: {self._output_path}")
    ...
    def _register_font() -> str:
        ...
        print("No handwriting TTF found — using Helvetica-Oblique as fallback")
